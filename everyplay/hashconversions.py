...
def normalize_param(key, value):
    ...
    by Everyplay. Heavily lifted from HTTParty.
    ...
    ...    {id: 1234}, {id: 4567}
    ...  ]})  # doctest:+ELLIPSIS
    {'playlist[videos][][<built-in function id>]': [1234, 4567], 'playlist[sharing]': 'private', 'playlist[title]': 'foo'}

    >>> normalize_param('access_token', 'foo')
    {'access_token': 'foo'}

    >>> normalize_param('playlist[videos]', [1234, 4567])
    {'playlist[videos][]': [1234, 4567]}
    """
    params = {}
    stack = []
